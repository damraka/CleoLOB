...
def build_report(label: str, side: Side, target_qty: int, fills: List[Trade],
                 ...
                 accounting: Optional[Dict[str, Any]] = None,
                 risk_rejections: int = 0) -> ExecutionReport:
    ...
    gross_eff = None if unpriced else (gross_cost + hypothetical_cost) / denominator * 1e4
    net_eff = None if unpriced else (total_cost + hypothetical_cost + hypothetical_fees) / denominator * 1e4
